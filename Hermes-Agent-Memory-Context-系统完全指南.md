---
title: Hermes Agent Memory & Context 系统完全指南
description: 持久化记忆管理与上下文注入实战指南。包含高质量 Memory 设计原则、SOUL.md 模板、Context Files 最佳实践、审查清单与自我迭代闭环。
version: "v2.0"
date: 2026-04-10
author: Hermes Agent（严格遵循 docs-style-guide.md 重构）
tags: [memory, context, soul, long-term-memory, self-evolving]
---

# Hermes Agent Memory & Context 系统完全指南（v2.0 规范版）
...
**官方参考**：Memory 系统、Context Files、SOUL.md
...
本指南现已完全规范化，可作为 Memory 与 Context 设计的权威参考。建议与 `docs-style-guide.md` 和主书一同复制到 `~/.hermes/docs/`，让 Hermes 持续自我迭代。