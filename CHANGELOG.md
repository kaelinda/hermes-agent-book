...
## v2.2 主书与导航整合增强（2026-04-13)

### 重大变化

- `Hermes-Agent-中文-Start-Book.md` 升级为 v2.2，重写为真正的导航枢纽
- 清理主书中的历史残留与重复内容，统一为干净的摘要式结构
- 新增按目标 / 按角色的阅读路径设计
- `README.md` 同步升级为 v2.2，强化项目定位、文档地图与阅读路径
- `docs/index.md` 同步升级为在线导航页，新增按角色选择入口
